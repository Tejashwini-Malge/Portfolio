...
const experiences = [
  ...
  },
  {
    ...
    desc: "Building the admin dashboard for an agentic AI NGO transparency platform. Integrated specialised agents for compliance validation, fraud detection, document verification, and campaign review into the NGO administration workflow.",
  ...
  },
  {
    ...
    period: "2023 — Present",
    desc: "Deliver AI and communication workshops across colleges and institutions, reaching 1000+ students. Also served as Speaker's Club Coordinator, running public speaking sessions and mentoring students on communication and presentation.",
    highlights: ["1000+ students reached", "Multiple institutions", "Speaker's Club Coordinator"],
  ...
  },
  {
    ...
    org: "Personal",
    period: "2023 — Present",
    desc: "Write about AI, networking, life as a final year student and career development on LinkedIn a community of 3,000+ professionals has grown around it.",
